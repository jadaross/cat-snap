...
- Connect with other cat enthusiasts through social features
- Explore and discover cats in their area
...
Your use of the App is also governed by our Privacy Policy, which can be found at https://catsnap.app/privacy. Please review our Privacy Policy to understand how we collect, use, and protect your information.
...
### Cat Information
Cat profiles and sighting data are community-sourced. While individual users contribute sightings, the aggregated cat profiles become part of the community database.
...
- The accuracy or completeness of cat sighting data
- Uninterrupted or error-free operation
- That the App will meet your requirements
- The security of the App despite our reasonable efforts
...
- Any content submitted by other users
...
- Respect the privacy of individuals and property owners

### Cat Welfare
- Do not endanger cats when taking photos
- Respect private property when spotting cats
- Do not disclose sensitive location information that could harm cats

### Accuracy
- Submit accurate sighting information
- Update information when cats' locations or status changes
- Report duplicate or incorrect cat profiles
...
### By You
You may delete your account at any time through the App's Settings. Account deletion permanently removes all your data, including sightings, photos, and social connections.
...
### Location Privacy
When submitting sightings, be mindful of:
- Not revealing exact addresses of private residences
- Avoiding locations that could endanger cats
